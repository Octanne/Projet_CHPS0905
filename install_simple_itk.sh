...
cd SimpleITK-build
ITK_DIR="../../ITK/ITK-build" Elastix_DIR="../../Elastix/build" cmake ../ -DSimpleITK_USE_ELASTIX=ON -DCMAKE_BUILD_TYPE=Release -DBUILD_EXAMPLES=OFF -DBUILD_TESTING=OFF -DWRAP_TCL=OFF -DWRAP_LUA=OFF -DWRAP_CSHARP=OFF -DWRAP_JAVA=OFF -DWRAP_PYTHON=ON
make -j8 # Adjust the number of jobs as needed
